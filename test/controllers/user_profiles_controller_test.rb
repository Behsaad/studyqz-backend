...
class UserProfilesControllerTest < ActionController::TestCase
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post :create, user_profile: { subject_id: @user_profile.subject_id, university_id: @user_profile.university_id, user_id: @user_profile.user_id, xp: @user_profile.xp }
    end
  ...
  test "should update user_profile" do
    patch :update, id: @user_profile, user_profile: { subject_id: @user_profile.subject_id, university_id: @user_profile.university_id, user_id: @user_profile.user_id, xp: @user_profile.xp }
    assert_redirected_to user_profile_path(assigns(:user_profile))
  end
